  ...
  return (
    <View className="flex-1 bg-[#1c1410] px-5 pt-10">
      ...
      <View
        ...
        <Text className="text-xl font-semibold text-[#f5e6d3]">Privacidad</Text>
      </View>

      <View className="items-center justify-center rounded-3xl border border-white/10 bg-white/5 py-12">
        <Ionicons name="shield-checkmark-outline" size={48} color="#D4A574" style={{ opacity: 0.8 }} />
        ...
        <Text className="mt-2 px-6 text-center text-sm text-[#8a7a6a]">
          Aquí podrás gestionar quién ve tus check-ins y tu perfil público.
        </Text>
      </View>
    </View>
  );
